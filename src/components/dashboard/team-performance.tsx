  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 p-5">
      ...
      <div className="grid grid-cols-12 gap-2 px-3 py-2 text-xs font-medium text-gray-500 border-b border-gray-100">
        ...
        <div className="col-span-2 text-center">მინიჭ.</div>
        ...
        {members.map((member) => (
          ...
          >
            ...
            <div className="col-span-2 text-center">
              <span className="text-sm font-medium text-gray-700">{member.assigned}</span>
            </div>
            ...
            <div className="col-span-2 text-center">
              <span
                className={cn(
                  ...
                  getRateBgColor(member.rate),
                  getRateColor(member.rate)
                )}
              >
                {member.rate}%
              </span>
