            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1.5">
                ...
                <p className="text-[10px] text-gray-500">
                  {isEdit
                    ? 'ნომრის შეცვლა არ შეცვლის შიდა იდენტიფიკატორს — ინვოისები და ფაილები დაკავშირებული დარჩება. დაშვებული სიმბოლოები: ასოები, ციფრები, "/", "-", "_", ".", "#" და ჰარები.'
                    : 'ცარიელი დატოვეთ ავტომატური გენერაციისთვის (GEO-YYYY-0001) ან ჩაწერეთ თქვენი ნომერი (მაგ. M-611948 / 2024)'}
                </p>
              </div>
              <div className="space-y-1.5">
                <Label>სტატუსი</Label>
